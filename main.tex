...
The packet delivery ratio remains within the range of 0.72 to 0.78 across most flows, indicating high communication reliability. Minor variations are observed under higher load conditions due to network congestion. The results confirm that the integration of lightweight authentication and adaptive routing mechanisms improves packet delivery efficiency compared to conventional approaches.
